...
public class JSONAnnotationController extends AbstractAnnotationController {
	...
	@Override
	public Response createAnnotation(String annotation) throws AnnotationDatabaseException, AnnotationFormatException, AnnotationModifiedException {
	...
	@Path("/{id}")
	@Override	
	public Response findAnnotationById(@PathParam("id") String id) throws AnnotationDatabaseException, AnnotationNotFoundException, UnsupportedEncodingException {
